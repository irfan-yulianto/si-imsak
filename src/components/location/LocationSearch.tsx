      ...
      <div className="relative">
        ...
        {isSearching ? (
          ...
          <button
            ...
            className="absolute right-3 top-1/2 -translate-y-1/2 cursor-pointer text-slate-400 transition-colors hover:text-slate-600 focus-visible:text-slate-600 focus-visible:outline-none dark:text-slate-500 dark:hover:text-slate-300"
            onClick={() => {
              setQuery("");
              setIsOpen(false);
