      ...
      <div className="relative">
        ...
        {query.length > 0 && (
          <button
            ...
            className="absolute right-3 top-1/2 -translate-y-1/2 rounded-full p-1 text-slate-400 hover:bg-slate-100 hover:text-slate-600 focus:outline-none focus:ring-2 focus:ring-emerald-400 dark:hover:bg-slate-700 dark:hover:text-slate-300"
