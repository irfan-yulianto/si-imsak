      ...
      <div className="relative">
        ...
        {!isSearching && query.length > 0 && (
          <button
            ...
            className="absolute right-3 top-1/2 -translate-y-1/2 rounded-md text-slate-400 hover:text-slate-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400 dark:text-slate-500 dark:hover:text-slate-300"
          >
            <XIcon size={14} />
          </button>
        )}
