        ...
        <div ref={searchRef} className="relative mb-3">
          ...
          {searchQuery.length > 0 && (
            <button
              ...
              className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 dark:text-slate-500 dark:hover:text-slate-300 rounded-sm"
            >
              <XIcon size={14} />
            </button>
          )}
